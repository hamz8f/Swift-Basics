(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[54],{"/+CK":function(e,t,n){"use strict"
var r=n("TqRt")
...
t.default=d},"40iR":function(e,t,n){"use strict"
var r=n("284h")
var i=n("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
t.default=void 0
...
var r=this.props,i=r.size,o=r.children,d=r.width,l=r.layout,c=r.selectRef,u=r.onBlur,f=r.required,g=r.disabled,p=r.value,b=r.defaultValue
var v=(0,m.omitProps)(this.props,t.propTypes)
var w=(e={},(0,a.default)(e,A.root,true),(0,a.default)(e,A[i],i),(0,a.default)(e,A.disabled,g),e)
var L=d?{width:d}:null
return s.default.createElement(_.default,Object.assign({},(0,m.pickProps)(this.props,_.default.propTypes),{layout:l,id:this.id}),s.default.createElement("span",{className:(0,h.default)(w),style:L},s.default.createElement("select",Object.assign({},v,{id:this.id,ref:function(e){n._select=e
for(var t=arguments.length,r=new Array(t>1?t-1:0),i=1;i<t;i++)r[i-1]=arguments[i]
c.apply(n,[e].concat(r))},value:p,defaultValue:b,onBlur:u,onChange:this.handleChange,onKeyDown:this.handleKeyDown,className:A.select,required:f,"aria-required":f,"aria-invalid":this.invalid?"true":null,"aria-disabled":g?"true":null,disabled:g}),o),s.default.createElement(y.default,{className:A.arrow})))}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex(function(e){return"error"===e.type})>=0}},{key:"focused",get:function(){return(0,v.default)(this._select)}},{key:"value",get:function(){return this._select.value}}])
t.displayName="Select"
return t}(s.Component),W.propTypes={children:b.Children.oneOf(["option"]),label:f.default.node.isRequired,disabled:f.default.bool,messages:f.default.arrayOf(j.default.message),id:f.default.string,size:f.default.oneOf(["small","medium","large"]),layout:f.default.oneOf(["stacked","inline"]),required:f.default.bool,inline:f.default.bool,width:f.default.string,selectRef:f.default.func,defaultValue:f.default.string,value:(0,b.controllable)(f.default.string),onChange:f.default.func,onBlur:f.default.func,onKeyDown:f.default.func},W.defaultProps={required:false,width:void 0,inline:false,type:"text",size:"medium",layout:"stacked",messages:[],disabled:false,selectRef:function(e){},children:null,id:void 0,value:void 0,defaultValue:void 0,onChange:void 0,onBlur:void 0,onKeyDown:void 0},z))||D)||D)
var M=P
t.default=M},"T/zx":function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:true})
t.default=i
var r=n("v+mX")
function i(e){var t=e.colors,n=e.borders,i=e.typography,a=e.forms,o=e.spacing
return{borderTopColor:t.borderMedium,borderRightColor:t.borderMedium,borderBottomColor:t.borderMedium,borderLeftColor:t.borderMedium,borderWidth:n.widthSmall,borderStyle:n.style,borderRadius:n.radiusMedium,background:t.backgroundLightest,color:t.textDarkest,fontFamily:i.fontFamily,fontWeight:i.fontWeightNormal,padding:o.small,arrowColor:t.textDarkest,smallHeight:a.inputHeightSmall,smallFontSize:i.fontSizeSmall,smallArrowWidth:"0.75rem",mediumHeight:a.inputHeightMedium,mediumFontSize:i.fontSizeMedium,mediumArrowWidth:"0.875rem",largeHeight:a.inputHeightLarge,largeFontSize:i.fontSizeLarge,largeArrowWidth:"1rem",focusBorderColor:t.borderBrand,focusOutlineColor:(0,r.alpha)(t.borderBrand,50),errorBorderColor:t.borderDanger,errorOutlineColor:(0,r.alpha)(t.borderDanger,50)}}i.canvas=function(e){return{color:e["ic-brand-font-color-dark"],arrowColor:e["ic-brand-font-color-dark"],focusBorderColor:e["ic-brand-primary"],focusOutlineColor:(0,r.alpha)(e["ic-brand-primary"],50)}}},YMPg:function(e,t,n){"use strict"
n.r(t)
...
var n="u".concat(d("",t-1))
return e&&false?"".concat(e,"__").concat(n):n}function o(e){var t=[]
while(0<e--)t.push(Math.floor(256*Math.random()))
return t}function d(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:12
var n=""
var a=o(t)
while(0<t--)n+=r[a[t]&i]
return n}n.d(t,"default",function(){return a})},dkPb:function(e,t,n){"use strict"
var r=n("284h")
var i=n("TqRt")
Object.defineProperty(t,"__esModule",{value:true})
...
//# sourceMappingURL=54-c-b09e1d0b2c.js.map