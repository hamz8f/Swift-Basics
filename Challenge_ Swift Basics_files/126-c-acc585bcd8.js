(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[126],{"26Wh":function(e,t,a){"use strict"
var i=a("ouhR")
var s=a.n(i)
a("GLiE")
var n=a("5Ky4")
...
a.find("li.separator").bind("dropout",function(e,t){r=null})
a.find("span.text").bind("dragstop",function(t,n){var o=true
...
a.dblclick(function(t){var a=s()(t.target)
...
s.a.each(["name","id","class"],function(a,i){t.attr(i)&&t.attr(i,t.attr(i).replace(/-iterator-/,e.iterator))})})
...
e.textValues.forEach(function(e){var t=i.find("."+e.replace(/\[/g,"\\[").replace(/\]/g,"\\]")+":first")
n=s.a.trim(t.text())
"&nbsp;"===t.html()&&(n="")
...
//# sourceMappingURL=126-c-acc585bcd8.js.map